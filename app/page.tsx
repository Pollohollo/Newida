  ...
  return (
    <main>
      <header className="site-header">
        <a className="brand" href="#top" aria-label="Maison Mère, accueil"><span className="brand-mark">MM</span><span>Maison Mère</span></a>
        <nav aria-label="Navigation principale">
          <a href="#projets">Projets</a><a href="#manifeste">Manifeste</a>
          <a className="nav-pill" href="mailto:bonjour@maisonmere.studio">Nous écrire <Arrow /></a>
        </nav>
      </header>
      ...
      <section className="hero" id="top">
        ...
        <p className="hero-copy">Nous imaginons, construisons et faisons grandir des produits utiles. Maison Mère est la porte d’entrée vers tout ce que notre équipe crée.</p>
      ...
      <footer>
        <div className="footer-brand">Maison Mère<span>✦</span></div><p>Le point de départ de nos prochaines idées.</p>
        <a href="mailto:bonjour@maisonmere.studio">bonjour@maisonmere.studio <Arrow /></a><small>© 2026 Maison Mère — Montréal, QC</small>
      </footer>
    </main>
  );
}
